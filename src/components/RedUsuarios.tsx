        ...
        <div className="bg-white border border-[#E4E7EE] rounded-2xl p-5 overflow-x-auto">
          <div className="flex items-center gap-4 mb-5 text-[12px] text-[#6B7280]">
            ...
            {hayReservadosEnVista && (
              <span className="flex items-center gap-1.5">
                <span className="w-3 h-3 rounded-full bg-[#6B7280] inline-block" /> Reservado (sin reclamar)
              </span>
            )}
          </div>
                ...
                {fila.map((nodo, j) =>
                  nodo && nodo.reservado ? (
                    <button
                      ...
                      title="Espacio reservado de la Red General — todavía nadie lo ha reclamado"
                      className={`px-3 py-1.5 rounded-lg border-2 text-[12px] font-medium whitespace-nowrap border-[#6B7280] bg-[#F0F1F4] text-[#6B7280] ${
